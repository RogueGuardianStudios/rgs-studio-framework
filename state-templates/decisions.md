...
# History is never erased — it is moved, not deleted.
...
Superseded and inactive decisions live in:
state/decisions-archive.md

If you need to trace a decision that no longer
appears here, check the archive before escalating.

---

## Compression Log

Record of every archiving action performed on
this file. Never removed. Only appended to.
